"use strict";exports.id=8882,exports.ids=[8882],exports.modules={28882:(e,s,r)=>{r.d(s,{Z:()=>k});var t=r(10326),a=r(17577),n=r(26107),l=r(90434),i=r(35047),d=r(4055),o=r(94019),c=r(26754),x=r(36283),m=r(941),h=r(39183),g=r(36728),u=r(67048),p=r(24061),f=r(71810),b=r(7619);function j({isOpen:e,onToggle:s}){let r=(0,i.usePathname)(),j=(0,i.useRouter)(),y=(0,i.useSearchParams)(),{user:v,logout:N}=(0,n.aC)(),{showLoader:w}=(0,d.r)(),[k,C]=(0,a.useState)(!1),[D,z]=(0,a.useState)([]),Z=()=>!!v&&[...b.uc,...b.oU,...b.gf,"Admin"].includes(v.role),A=(0,a.useMemo)(()=>v?.sites&&0!==D.length?D.filter(e=>v.sites.includes(e.id)):[],[v?.sites,D]),[F,R]=(0,a.useState)(!1),S=async()=>{try{R(!0),await N(),j.push("/")}catch(e){console.error("Logout error:",e)}finally{R(!1)}},$=e=>r===e||r.startsWith(e+"/");return v?(0,t.jsxs)(t.Fragment,{children:[e&&t.jsx("div",{className:"lg:hidden fixed inset-0 bg-black bg-opacity-50 z-30",onClick:s}),(0,t.jsxs)("div",{className:`
      ...
      `,children:[(0,t.jsxs)("div",{className:"bg-gradient-to-r from-orange-600 to-orange-700 text-white p-4 lg:p-6",children:[t.jsx("div",{className:"lg:hidden flex justify-end mb-2",children:t.jsx("button",{onClick:s,className:"p-1 rounded-md hover:bg-white hover:bg-opacity-20",children:t.jsx(o.Z,{size:20})})}),(0,t.jsxs)("div",{className:"space-y-1",children:[(0,t.jsxs)("h3",{className:"font-semibold text-lg truncate",children:["Welcome ",v.email?.split("@")[0]]}),(0,t.jsxs)("p",{className:"text-orange-100 text-sm",children:["Role: ",v.role]}),A.length>0&&(0,t.jsxs)("div",{children:[t.jsx("p",{className:"text-orange-100 text-xs",children:"Site:"}),t.jsx("div",{className:"pl-2",children:A.map(e=>(0,t.jsxs)("p",{className:"text-orange-100 text-xs truncate",title:e.name,children:["- ",e.name]},e.id))})]})]})]}),(0,t.jsxs)("nav",{className:"flex-1 p-4 space-y-2 overflow-y-auto",children:[(0,t.jsxs)(l.default,{href:"/dashboard",onClick:w,className:`
            ...
            `,children:[t.jsx(c.Z,{className:"w-5 h-5 mr-3"}),"Dashboard"]}),Z()&&(0,t.jsxs)("div",{className:"space-y-1",children:[(0,t.jsxs)("button",{onClick:()=>{C(!k)},className:`
                ...
                `,children:[(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[t.jsx(x.Z,{size:18}),t.jsx("span",{children:"RFA Documents"})]}),k?t.jsx(m.Z,{size:16}):t.jsx(h.Z,{size:16})]}),k&&(0,t.jsxs)("div",{className:"ml-6 space-y-1 border-l-2 border-orange-200 pl-4",children:[(0,t.jsxs)(l.default,{href:"/dashboard/rfa?type=RFA-SHOP",onClick:w,className:`
                    ...
                    `,children:[t.jsx("div",{className:"w-2 h-2 bg-orange-500 rounded-full"}),t.jsx("span",{children:"\uD83E\uDDF1 Material"})]})]})]}),Z()&&(0,t.jsxs)(l.default,{href:"/rfi",onClick:w,className:`
                flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium
                transition-colors duration-200
                ${$("/rfi")?"bg-orange-200 text-orange-900":"text-gray-700 hover:bg-orange-100 hover:text-orange-800"}
              `,children:[t.jsx(g.Z,{size:18}),t.jsx("span",{children:"RFI"})]}),(0,t.jsxs)(l.default,{href:"/dashboard/work-request",onClick:w,className:`
              flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium
              transition-colors duration-200
